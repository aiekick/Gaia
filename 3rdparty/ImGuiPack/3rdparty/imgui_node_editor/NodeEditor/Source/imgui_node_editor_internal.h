...
struct IMGUI_API Node final: Object
{
    using IdType = NodeId;
...
struct IMGUI_API Link final: Object
{
    using IdType = LinkId;
...
struct IMGUI_API NavigateAnimation final: Animation
{
...
struct IMGUI_API FlowAnimation final: Animation
{
...
struct IMGUI_API AnimationController
{
    EditorContext* Editor;
...
struct IMGUI_API FlowAnimationController final : AnimationController
{
...
struct IMGUI_API NavigateAction final: EditorAction
{
...
struct IMGUI_API SizeAction final: EditorAction
{
    bool  m_IsActive;
    bool  m_Clean;
    Node* m_SizedNode;
...
struct IMGUI_API DragAction final: EditorAction
{
    bool            m_IsActive;
    bool            m_Clear;
...
struct IMGUI_API SelectAction final: EditorAction
{
    bool            m_IsActive;
...
struct IMGUI_API ContextMenuAction final: EditorAction
{
...
struct IMGUI_API ShortcutAction final: EditorAction
{
...
struct IMGUI_API CreateItemAction final : EditorAction
{
    enum Stage
    {
        None,
...
struct IMGUI_API EditorContext
{
    ...
    const ImGuiEx::CanvasView& GetView() const { return m_Canvas.GetView(); }
    const ImRect& GetViewRect() const { return m_Canvas.ViewRect(); }
    const ImRect& GetRect() const { return m_Canvas.Rect(); }
    
    void SetView(const ImGuiEx::CanvasView& vCanvasView) { m_Canvas.SetView(vCanvasView.Origin, vCanvasView.Scale); }
    ...
    void NavigateTo(const ImVec2& vOffset) 
    { 
        m_NavigateAction.m_Scroll = -vOffset; 
    }
    void NavigateTo(float vScale)
    {
        m_NavigateAction.m_Zoom = vScale;
    }
    void NavigateTo(const ImVec2& vOffset, float vScale)
    {
        m_NavigateAction.m_Scroll = vOffset;
        m_NavigateAction.m_Zoom = vScale;
    }
