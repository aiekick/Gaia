...
#include <Gaia/Utils/Mesh/MeshInfo.h>
...
public:
    ...
    MeshShaderPass(GaiApi::VulkanCoreWeak vVulkanCore,
...
template <typename T_VertexType>
MeshShaderPass<T_VertexType>::MeshShaderPass(GaiApi::VulkanCoreWeak vVulkanCore, const MeshShaderPassType& vMeshShaderPassType)
    : ShaderPass(vVulkanCore, (GenericType)vMeshShaderPassType) {
    ZoneScoped;
}

template <typename T_VertexType>
MeshShaderPass<T_VertexType>::MeshShaderPass(GaiApi::VulkanCoreWeak vVulkanCore,
    const MeshShaderPassType& vMeshShaderPassType,
    vk::CommandPool* vCommandPool,
    vk::DescriptorPool* vDescriptorPool)
    : ShaderPass(vVulkanCore, (GenericType)vMeshShaderPassType, vCommandPool, vDescriptorPool) {
    ZoneScoped;
}
