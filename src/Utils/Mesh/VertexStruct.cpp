...
void P3_C4::GetInputState(PipelineVertexInputState& vInputState) {
...

    {
        ...
        offset += sizeof(ez::fvec4);
    }

    vInputState.state = vk::PipelineVertexInputStateCreateInfo(vk::PipelineVertexInputStateCreateFlags(), 1, &vInputState.binding,
        static_cast<uint32_t>(vInputState.attributes.size()), vInputState.attributes.data());
}
P3_C4::P3_C4() = default;
P3_C4::P3_C4(ez::fvec3 vp) {
    p = vp;
}
P3_C4::P3_C4(ez::fvec3 vp, ez::fvec4 vc) {
    p = vp;
    c = vc;
}
...
P3_N3_C4::P3_N3_C4(ez::fvec3 vp) {
    p = vp;
}
P3_N3_C4::P3_N3_C4(ez::fvec3 vp, ez::fvec3 vn) {
    p = vp;
    n = vn;
}
P3_N3_C4::P3_N3_C4(ez::fvec3 vp, ez::fvec3 vn, ez::fvec4 vc) {
    p = vp;
    n = vn;
    c = vc;
}
...
P3_N3_C4_D1::P3_N3_C4_D1(ez::fvec3 vp) {
    p = vp;
}
P3_N3_C4_D1::P3_N3_C4_D1(ez::fvec3 vp, ez::fvec3 vn) {
    p = vp;
    n = vn;
}
P3_N3_C4_D1::P3_N3_C4_D1(ez::fvec3 vp, ez::fvec3 vn, ez::fvec4 vc) {
    p = vp;
    n = vn;
    c = vc;
}
P3_N3_C4_D1::P3_N3_C4_D1(ez::fvec3 vp, ez::fvec3 vn, ez::fvec4 vc, float vd) {
    p = vp;
    n = vn;
    c = vc;
    d = vd;
...
P2_T2::P2_T2() = default;
P2_T2::P2_T2(ez::fvec2 vp) {
    p = vp;
}
P2_T2::P2_T2(ez::fvec2 vp, ez::fvec2 vt) {
    p = vp;
    t = vt;
}
...
P3_N3_T2::P3_N3_T2(ez::fvec3 vp) {
    p = vp;
}
P3_N3_T2::P3_N3_T2(ez::fvec3 vp, ez::fvec3 vn) {
    p = vp;
    n = vn;
}
P3_N3_T2::P3_N3_T2(ez::fvec3 vp, ez::fvec3 vn, ez::fvec2 vt) {
    p = vp;
    n = vn;
    t = vt;
}
...
P3_N3_T2_C4::P3_N3_T2_C4(ez::fvec3 vp) {
    p = vp;
}
P3_N3_T2_C4::P3_N3_T2_C4(ez::fvec3 vp, ez::fvec3 vn) {
    p = vp;
    n = vn;
}
P3_N3_T2_C4::P3_N3_T2_C4(ez::fvec3 vp, ez::fvec3 vn, ez::fvec2 vt) {
    p = vp;
    n = vn;
    t = vt;
}
P3_N3_T2_C4::P3_N3_T2_C4(ez::fvec3 vp, ez::fvec3 vn, ez::fvec2 vt, ez::fvec4 vc) {
    p = vp;
    n = vn;
    t = vt;
    c = vc;
...
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ez::fvec3 vp) {
    p = vp;
}
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ez::fvec3 vp, ez::fvec3 vn) {
    p = vp;
    n = vn;
}
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ez::fvec3 vp, ez::fvec3 vn, ez::fvec3 vtan) {
    p = vp;
    n = vn;
    tan = vtan;
}
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ez::fvec3 vp, ez::fvec3 vn, ez::fvec3 vtan, ez::fvec3 vbtan) {
    p = vp;
    n = vn;
    tan = vtan;
    btan = vbtan;
}
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ez::fvec3 vp, ez::fvec3 vn, ez::fvec3 vtan, ez::fvec3 vbtan, ez::fvec2 vt) {
    p = vp;
    n = vn;
    tan = vtan;
    btan = vbtan;
...
P3_N3_TA3_BTA3_T2_C4::P3_N3_TA3_BTA3_T2_C4(ez::fvec3 vp, ez::fvec3 vn, ez::fvec3 vtan, ez::fvec3 vbtan, ez::fvec2 vt, ez::fvec4 vc) {
    p = vp;
    n = vn;
    tan = vtan;
    btan = vbtan;
